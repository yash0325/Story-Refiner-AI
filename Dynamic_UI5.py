...
def clear_connection_state():
    for k in [
        ...
        "last_refined_criteria", "last_selected_issue_key", "last_task_breakdown"
    ]:
            ...
            if (
                ...
                if st.button("🛠️ Break Down Into Tasks"):
                    with st.spinner("Breaking down into tasks..."):
                        ...
                        # Use refined output for higher quality
